...
//    }
    ...
    /** Click on unitary functions. Sin, cos, sqrt, arcsin... */
...
//        }
        ...
        switch (((Button)view).getText().toString()){
            ...
            case "&#8730;":
                binding.tvExpression.append("sqrt(");
    ...
    public Boolean isLastNumberDecimal(String str){
    ...
    public Boolean isLastDigit(String str){
